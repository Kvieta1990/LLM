...
def create_user_prompt(training_line):
    ...
    user_prompt = f"""I am creating a set of training data. The context and original training sample provided should serve as a guide. Your task is to generate 15 variations of this training data. Please strictly adhere to the following instructions:
...
Task Instructions:
    ...
    1. Generate 15 Variations:
        ...
        - Final 5 Variations:
            ...
            - Conclude with an answer similar to the original.
