...
training_examples = generate_processing_training_data()
with open('train_data_proc_instr.jsonl', 'w') as f:
    for example in training_examples:
        f.write(json.dumps(example) + '\n')

print(f"Generated {len(training_examples)} training examples")
print("Training data covers:")
print("- 6 instruments (POWGEN, NOMAD, HB2C, WAND^2, WAND, HB2A)")
print("- 2 question types per instrument (rerun, process)")
print(f"- {len([p for p in []])+15} rerun question patterns")
print(f"- {len([p for p in []])+15} process question patterns")
print("- Output in JSONL format")
print("Saved to train_data_proc_instr.jsonl")
